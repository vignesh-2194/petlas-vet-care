...
export const AppLayout: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-[#F8FAFC] text-[#1E293B] flex flex-col font-sans relative selection:bg-teal-100 selection:text-teal-900">
            ...
            <nav className={`fixed top-0 left-0 w-full z-50 transition-all duration-500 ${scrolled ? 'bg-white/80 backdrop-blur-xl border-b border-slate-100 shadow-sm py-4' : 'bg-transparent py-6'
                }`}>
                ...
                <div className="max-w-7xl mx-auto px-6 py-8 flex flex-col md:flex-row justify-between items-center gap-6">
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-6">
                        <div className="flex gap-4 text-slate-500 font-medium">
                            <a href="#privacy" className="hover:text-[#14B8A6] transition-colors">Privacy Policy</a>
                            <a href="#terms" className="hover:text-[#14B8A6] transition-colors">Terms of Service</a>
                        </div>
                        <span className="text-slate-500 font-sans text-[11px]">&copy; {new Date().getFullYear()} Petla's Vet Care. All rights reserved.</span>
                    </div>
                </div>
            </footer>
